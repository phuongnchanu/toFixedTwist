...
(function(root, undefined) {
   ...
   *
   * Fixes binary rounding issues (eg. (0.615).toFixed(2) === "0.61", (1.005).toFixed(2) === "1.00") that present
  ...
  var toFixedTwist = lib.toFixedTwist = function(value, precision) {
    ...
    if (decimalPart.length < precision) {
      decimalPart += '0'.repeat(precision);
    }

    var number = Number(wholeNumberPart + decimalPart.slice(0, precision) + decimalSymbol + decimalPart.slice(precision));
